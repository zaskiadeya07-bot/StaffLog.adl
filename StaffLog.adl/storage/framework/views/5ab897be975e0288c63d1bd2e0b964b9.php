...
<div>
    ...
    <div class="card p-5 mb-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <a href="<?php echo e(url('/karyawan/check-in')); ?>" class="bg-emerald-50 p-5 rounded-xl text-center hover:bg-emerald-100 transition border-2 border-emerald-200 block no-underline">
            ...
            <a href="<?php echo e(url('/karyawan/check-out')); ?>" class="bg-red-50 p-5 rounded-xl text-center hover:bg-red-100 transition border-2 border-red-200 block no-underline">
            ...
            <a href="<?php echo e(url('/karyawan/izin-cuti')); ?>" class="bg-amber-50 p-5 rounded-xl text-center hover:bg-amber-100 transition border-2 border-amber-200 block no-underline">
...
<?php echo $__env->make('layouts.karyawan-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\StaffLog.adl\StaffLog.adl\resources\views/karyawan/dashboard.blade.php ENDPATH**/ ?>