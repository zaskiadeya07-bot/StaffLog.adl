...
function performAction() {
    ...
    fetch('<?php echo e(route("karyawan.checkin.store")); ?>', {
        ...
        headers: {
            'Content-Type': 'application/json',
            'X-CSRF-TOKEN': '<?php echo e(csrf_token()); ?>',  // Token keamanan Laravel
            'Accept': 'application/json'
        },
        body: JSON.stringify({
...
<?php echo $__env->make('layouts.karyawan-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\StaffLog.adl\StaffLog.adl\resources\views/karyawan/check-in.blade.php ENDPATH**/ ?>