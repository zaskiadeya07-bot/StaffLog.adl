                    ...
                    <div>
                        ...
                        <select id="divisi" class="input-field" required>
                            ...
                            <?php $__currentLoopData = $divisis; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $divisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($divisi->id_devisi); ?>"><?php echo e($divisi->nama_devisi); ?></option>
...
<script>
    document.getElementById('tambahKaryawanForm').addEventListener('submit', async function(e) {
        ...
        try {
            const response = await fetch('<?php echo e(route("admin.tambah-karyawan.store")); ?>', {
                method: 'POST',
                headers: {
...
<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\StaffLog.adl\StaffLog.adl\resources\views/admin/tambah-karyawan.blade.php ENDPATH**/ ?>