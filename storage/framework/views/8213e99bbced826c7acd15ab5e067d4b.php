    ...
    <header class="bg-slate-800 sticky top-0 z-50 shadow-lg">
        <div class="container mx-auto px-6 py-4">
            <div class="flex justify-end">
                <a href="<?php echo e(route('login')); ?>" class="bg-amber-400 text-slate-800 px-6 py-2 rounded-full font-semibold hover:bg-amber-500 transition flex items-center gap-2">
...
<?php echo $__env->make('layouts.admin-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\rekapkehadiran\resources\views/layouts/admin-layout.blade.php ENDPATH**/ ?>