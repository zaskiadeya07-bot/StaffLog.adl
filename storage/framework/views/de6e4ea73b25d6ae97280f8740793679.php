<?php $__env->startSection('title', 'Check In / Absen Masuk'); ?>
...
<div>
    ...
    <div class="flex justify-between items-center mb-6 flex-wrap gap-3">
        <div>
            ...
            <p class="text-slate-500 text-sm">Validasi lokasi aktif dengan radius kantor <?php echo e($setting->radius ?? 100); ?> meter.</p>
        </div>
...
// =========================================================================
// CEK STATUS CHECK IN HARI INI (SESUAI RESPONSE CONTROLLER)
// =========================================================================
function checkTodayAttendance() {
    fetch('<?php echo e(route("karyawan.checkin.status")); ?>', {
        method: 'GET',
        headers: {
    ...
    .then(function(result) {
        // PERBAIKAN: Controller mengirim 'hasCheckedIn'
        if (result.hasCheckedIn === true) {
...
// =========================================================================
// PROSES CHECK IN (SESUAI REQUEST CONTROLLER)
// =========================================================================
function performAction() {
    ...
    if (!currentPosition) {
        alert('Lokasi tidak terdeteksi. Silakan tunggu sebentar.');
        return;
    }
    ...
    fetch('<?php echo e(route("karyawan.checkin.store")); ?>', {
        method: 'POST',
        headers: {
            'Content-Type': 'application/json',
        ...
        body: JSON.stringify({
            ...
            jam_masuk: jamMasuk  // ← KIRIM JAM MASUK
        })
    })
    .then(function(response) {
        return response.json();
...
<?php echo $__env->make('layouts.karyawan-layout', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\StaffLog.adl\resources\views/karyawan/check-in.blade.php ENDPATH**/ ?>