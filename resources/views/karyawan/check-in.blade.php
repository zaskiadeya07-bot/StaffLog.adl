...
<div>
    <div class="flex justify-between items-center mb-6 flex-wrap gap-3">
        <div><h1 class="text-2xl font-bold text-slate-800">Check In</h1><p class="text-slate-500 text-sm">Validasi lokasi aktif dengan radius kantor {{ $setting ? $setting->radius : 100 }} meter.</p></div>
