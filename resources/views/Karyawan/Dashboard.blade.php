...
<div>
    ...
    <div class="bg-slate-800 rounded-2xl p-6 mb-6 text-white">
        <div class="flex justify-between items-center">
            <div>
                <h1 class="text-2xl font-bold mb-1">Halo, <span id="welcomeName">{{ session('pengguna_nama', 'Karyawan') }}</span>!</h1>
    ...
    <div class="card p-5">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 gap-3">
            <div class="bg-emerald-50 rounded-xl p-4 text-center">
                ...
                <p class="text-2xl font-bold text-emerald-600" id="statHadir">{{ $statHadir ?? 0 }}</p>
            ...
            <div class="bg-amber-50 rounded-xl p-4 text-center">
                ...
                <p class="text-2xl font-bold text-amber-600" id="statTerlambat">{{ $statTerlambat ?? 0 }}</p>
            ...
            <div class="bg-blue-50 rounded-xl p-4 text-center">
                ...
                <p class="text-2xl font-bold text-blue-600" id="statIzin">{{ $statIzin ?? 0 }}</p>
            ...
            <div class="bg-red-50 rounded-xl p-4 text-center">
                ...
                <p class="text-2xl font-bold text-red-600" id="statSakit">0</p>
